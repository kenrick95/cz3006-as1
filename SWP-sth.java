...
*========================================================================*/
	...
	*/
	...
	private void start_timer(int seq) {
		...
		timer[seq % NR_BUFS].schedule(new timeout(seq), 200);
	}
	...
	private void start_ack_timer( ) {
		...
		ack_timer = new Timer();
		ack_timer.schedule(new ack_timeout(), 50);
	}
	...
	class ack_timeout extends TimerTask {
	...
	class timeout extends TimerTask {
		...
		public timeout(int sequenceNo) {
			this.sequenceNo = sequenceNo;
		}
		
		public void run() {
			//stops this timer, discarding any scheduled tasks for the current seq
			stop_timer(sequenceNo);
			swe.generate_timeout_event(sequenceNo);
		}
	}
